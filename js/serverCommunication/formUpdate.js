...
function updateFormData(responseJSON) {
    ...
    if (form != null) {
        for (let j in elements) {
            ...
            //BUTTON,PLUS,MINUS asi netreba, nemeni sa
...
//potvrdenie prijatia aplikacie + TEST funkcionality
function confirmGettingAppliance() {
    generateSpeechCommands(createdAppliance);
    console.log(JSON.stringify(createdAppliance.filter(app => app.name === 'Speaker')));
