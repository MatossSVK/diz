...
function generateHomes(homes) {
    ...
    setTimeout(function () {
        ...
        buttonBack.setAttribute('onclick', "appliancesFromToBackHomes()");
        ...
        buttonNext.setAttribute('onclick', "appliancesFromToNextHomes()");
...
function appliancesFromToBackHomes() {
    startHome = startHome - 5;
    refreshHomes();
}

//tlacidlo dalej v zoznamie domacnosti
function appliancesFromToNextHomes() {
    startHome = startHome + 5;
    refreshHomes();
}
