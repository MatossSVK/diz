...
function displayHelp() {
    ...
    help.setAttribute('font-size', '55px');
    help.setAttribute('height', '1');
    ...
    mainTitle.setAttribute('position', '0 0.6 0.001');
    ...
    iconX.setAttribute('position', '0.77 0.39 0');
    ...
    next.setAttribute('position', '0 -0.4 0');
    next.setAttribute('icon-font-size', '95px');
    ...
    back.setAttribute('position', '0 -0.4 0');
    back.setAttribute('icon-font-size', '95px');
